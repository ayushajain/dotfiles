(function() {
	...
	scheme = c + "://", host =
		"open.t.qq.com", a = {
			...
			copy: function(a, b, c,
				d) {
				for (var e in b)
					if (c || typeof a[e] == "undefined") a[e] = d ? d(b[e]) : b[e];
				return a
			},
			create: function(a,
				b) {
			...
			extend: function(b, c, d) {
				return a.copy(typeof b == "string" ?
					a.create.call(this, b) : b, c, d)
			},
			_alias: function(b, c) {
				c = c ||
					a;
		...
		startsWith: String.prototype.startsWith ? function(a,
			b) {
			return a ==
				null ?
				!1 :
		...
		endsWith: String.prototype.endsWith ? function(a, b) {
			return a == null ?
				!1 :
	...
	QQWB.extend("_apiProvider", {
		...
		_apiGetErrorMessage: function(a,
			b) {
			var
				c = [],
				a =
		...
		compat: function(a) {
			return !QQWB.String.startsWith(a,
					"/") &&
				(a =
					"/" +
					a),
	...
	"function" && (JSON.parse = function(text, reviver) {
		function walk(a, b) {
			...
			if (e &&
				typeof e == "object")
				for (c in e)
					Object.prototype.hasOwnProperty.call(e, c) && (d = walk(e, c), d !== undefined ? e[c] = d :
						delete e[c]);
...
QQWB.extend("JSON", {
		fromString: function(a) {
			...
			if (window.JSON && window.JSON.parse) a =
				window.JSON.parse(a);
			else if (/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
					"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
					"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
					"")))
				a = (new Function("return " + data))();
			else throw
			new SyntaxError("Invalid JSON: " + a);
			return a
		},
	...
	QQWB.provide("man", function(a) {
		return a =
			this._apiProvider.compat(a),
			this._apiProvider.getDescriptor(a) ?
			QQWB.JSON.stringify(this._apiProvider.getDescriptor(a)) : "no such api"
	}), QQWB.extend("Array", {
		isArray: function(a) {
			return
		...
		toArray: function(a) {
			return typeof a == "string" ?
				a.split("") : typeof a == "object" ? Array.prototype.slice.call(a, 0) :
				this.toArray(a.toString())
		},
		each: function(a, b) {
			for (var c = 0, d =
					a.length; c < d; c++)
	...
	QQWB.extend("dom", {
		...
		var h = function(b,
			...
			while (k);
			if (w.length > 1 && j.exec(b))
				if (w.length === 2 && i.relative[w[0]]) l =
					s(w[0] + w[1], d);
				else {
					l =
						i.relative[w[0]] ? [d] :
				...
				!f && w.length > 1 && d.nodeType === 9 && !v && i.match.ID.test(w[0]) &&
					!i.match.ID.test(w[w.length - 1]) && (p = h.find(w.shift(), d, v), d = p.expr ?
						h.filter(p.expr,
							p.set)[0] :
						p.set[0]);
				if (d) {
			...
			n || (n = l), n || h.error(q || b);
			if (c.call(n) === "[object Array]")
				if (!u)
					e.push.apply(e, n);
				else if (d &&
				d.nodeType === 1)
				for (t =
					0; n[t] != null; t++) n[t] && (n[t] === !0 ||
						n[t].nodeType === 1 &&
						h.contains(d,
							n[t])) &&
					e.push(l[t]);
							...
							for (var
								...
								filter: {
									...
									function() {
										...
										if (b) {
											var
												c = !b.call(document.createElement("div"),
													"div"),
												d = !1;
											try {
								...
								function() {
									function b(b) {
										...
										this;
										c = [];
										for (var d = 0, e = this.length; d < e; d++) c =
											c.concat(a(b, this[d]));
										return c
									}

									function c(b) {
										return typeof b != "string" ? this : b.length <= 0 ? this :
									...
									var a =
										window.Sizzle;
									a.noConflict(), QQWB.provide("dom.find",
											function(b, c) {
												return h(a(b, c))
											}),
								...
								QQWB.extend("time", {
									...
									shortTime: function(a, b) {
										return a instanceof
										Date || (b = a, a = this.dateNow()), b = b || "%(year)s/%(month)s/%(day)s % (hour) 02 d: % (minute) 02 d: % (second) 02 d ",
											QQWB.format.sprintf(b, {
												year: a.getFullYear(),
												month: a.getMonth(),
												day: a.getDate(),
												hour: a.getHours(),
									...
									warning: function(a) {
										return this.WARNING >= this._level &&
									...
									critical: function(a) {
										return this.CRITICAL >= this._level &&
											this._out("CRITICAL",
												a),
											this
									},
									...
									lastCaptured: function(a) {
										...
										set: function(a, b, c,
											...
											return c === 0 ? i = "expires=" + (new Date(1970,
													1, 1)).toUTCString() : c > 0 && (i = "expires=" + (new Date(+(new Date) + c *
													1e3)).toUTCString()),
										...
										del: function(a, b, c) {
											return this.set(a, "",
													0, b, c), document.cookie.indexOf(a + "=") >= 0 &&
												QQWB.log.warning("Cookie
													may not be deleted as you expected "),
													this
												}
										}), QQWB.extend("XML", {
										isXML: function(a) {},
										...
										stringify: function(a) {
											var b;
											return window.ActiveXObject ? b = a.xml : b = (new XMLSerializer).serializeToString(a),
												b
										},
										fromString: function(a) {
											var
											...
											var a = [],
												b, c, d, e = {
														...
														if (!d) {
															...
															for (var
																	h = 0, i =
																	c.length; h < i; h++) f = c[h],
																QQWB.Array.isArray(f) ?
																e.done.apply(e, f) :
																QQWB.Function.isFunction(f) && a.push(f);
															g &&
																		...
																		return {
																			...
																			_apiResponder: function(a) {
																				...
																				function(b, c, d, e, f, g, h) {
																					var i, j;
																					b !== 200 ? (b = 2e6 +
																							Math.abs(b ? b : 0), a.reject(b, c, d, "")) : typeof(i = QQWB._apiProvider._apiParseRetCode(f)) == "number" &&
																						0 !== i ? (j =
																	...
																	QQWB.extend("_token", {
																			setAccessToken: function(a,
																				...
																				var
																					...
																					this.getTokenUser(!0);
																				return
																				QQWB.cookie.set(QQWB._cookie.names.accessToken, [a,
																							QQWB.time.now() +
																							b *
																							1e3,
																							c ||
																								...
																								QQWB.String.isString(a) &&
																									...
																									(!a.expires_in &&
																										QQWB.log.error("token
																											expires_in not retrieved "),!a.wb_name &&
																											QQWB.log.warning("weibo
																												username not retrieved,
																												will not update username "),!a.wb_nick &&
																												QQWB.log.warning("weibo
																													usernick not retrieved,
																													will not update usernick "),
																																		...
																																		QQWB.String.isString(a) &&
																																			...
																																			(!a.expires_in &&
																																				QQWB.log.error("token
																																					expires_in not retrieved "),!a.wb_name &&
																																					QQWB.log.warning("weibo
																																						username not retrieved "),!a.wb_nick &&
																																						QQWB.log.warning("weibo
																																							usernick not retrieved "),
																																							QQWB._token.setAccessToken(a.access_token,
																																								parseInt(a.expires_in,
																																							...
																																							QQWB.log.error("refresh
																																								...
																																								QQWB.log.info("retrieve
																																									new access token succeed ")):
																																									a.error ?
																																									QQWB.log.error("retrieve
																																										new access token error " +
																																										a.error) :
																																									QQWB.log.error("unexpected
																																										result returned from server " +
																																										b +
																																										"
																																										while retrieving new access token ")
																																									}).error(function(a,
																																										b) {
																																										a
																																											===
																																								...
																																								function() {
																																									function j(a) {
																																										a = a.toLowerCase();
																																										var b = e.exec(a) || d.exec(a) ||
																																											c.exec(a) || a.indexOf("compatible") < 0 && f.exec(a) || [];
																																										return {
																																											browser: b[1] || "unknown",
																																											version: b[2] || "0"
																																										}
																																									...
																																									function l() {
																																										var a = navigator.userAgent || navigator.vendor ||
																																											window.opera;
																																										return /android.+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge | maemo | midp | mmp | opera m(ob | in ) i | palm(
																																										os) ? | phone | p(ixi | re)\ / | plucker | pocket | psp | symbian | treo | up\.(browser | link) | vodafone | wap | windows(ce | phone) | xda | xiino / i.test(a) ||
																																										/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a
																																									wa | abac | ac(er | oo | s\ - ) | ai(ko | rn) | al(av | ca | co) | amoi | an(ex | ny | yw) | aptu | ar(ch | go) | as(te | us) | attw | au(di | \-m | r | s) | avan | be(ck | ll | nq) | bi(lb | rd) | bl(ac | az) | br(e | v) w | bumb | bw\ - (n | u) | c55\ / | capi | ccwa | cdm\ - | cell | chtm | cldc | cmd\ - | co(mp | nd) | craw | da(it | ll | ng) | dbte | dc\ - s | devi | dica | dmob | do(c | p) o | ds(12 | \-d) | el(49 | ai) | em(l2 | ul) | er(ic | k0) | esl8 | ez([4 - 7] 0 | os | wa | ze) | fetc | fly(\- | _) | g1
																																										u | g560 | gene | gf\ - 5 | g\ - mo | go(\.w | od) | gr(ad | un) | haie | hcit | hd\ - (m | p | t) | hei\ - | hi(pt | ta) | hp(
																																											i | ip) | hs\ - c | ht(c(\- |
																																											| _ | a | g | p | s | t) | tp) | hu(aw | tc) | i\ - (20 | go | ma) | i230 | iac( | \- | \/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( | \/)|klon|kpt | kwc\ - | kyo(c | k) | le(no | xi) | lg(
																																											g | \/(k|l|u)|50|54|e\-|e\/|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(di|rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| | o | v) | zz) | mt(50 | p1 | v) | mwbp | mywa | n10[0 - 2] | n20[2 - 3] | n30(0 | 2) | n50(0 | 2 | 5) | n7(0(0 | 1) | 10) | ne((c | m)\ - | on | tf | wf | wg | wt) | nok(6 | i) | nzph | o2im | op(ti | wv) | oran | owg1 | p800 | pan(a | d | t) | pdxg | pg(13 | \-([1 - 8] | c)) | phil | pire | pl(ay | uc) | pn\ - 2 | po(ck | rt | se) | prox | psio | pt\ - g | qa\ - a | qc(07 | 12 | 21 | 32 | 60 | \-[2 - 7] | i\ - ) | qtek | r380 | r600 | raks | rim9 | ro(ve | zo) | s55\ / | sa(ge | ma | mm | ms | ny | va) | sc(01 | h\ - | oo | p\ - ) | sdk\ / | se(c(\- | 0 | 1) | 47 | mc | nd | ri) | sgh\ - | shar | sie(\- | m) | sk\ - 0 | sl(45 | id) | sm(al | ar | b3 | it | t5) | so(ft | ny) | sp(01 | h\ - | v\ - | v) | sy(01 | mb) | t2(18 | 50) | t6(00 | 10 | 18) | ta(gt | lk) | tcl\ - | tdg\ - | tel(i | m) | tim\ - | t\ - mo | to(pl | sh) | ts(70 | m\ - | m3 | m5) | tx\ - 9 | up(\.b | g1 | si) | utst | v400 | v750 | veri | vi(rg | te) | vk(40 | 5[0 - 3] | \-v) | vm40 | voda | vulc | vx(52 | 53 | 60 | 61 | 70 | 80 | 81 | 83 | 85 | 98) | w3c(\- | ) | webc | whit | wi(g | nc | nw) | wmlb | wonu | x700 | xda(\- | 2 | g) | yas\ - | your | zeto | zte\ - /i.test(a.substr(0,
																																											4)) ? {
																																									mobile:
																																										!0
																																								} : {
																																							...
																																							function m() {
																																								var a = navigator.appVersion,
																																									...
																																									c = "unknown";
																																								return
																																								a.indexOf("Win") != -1 && (c = "windows"), a.indexOf("Mac") != -1 && (c = "mac"), a.indexOf("X11") != -1 && (c = "unix"),
																																									a.indexOf("Linux") != -1 && (c = "linux"), b[c] = !0, b
																																							}
																																							var a, b = navigator.userAgent, c = /(msie) ([\w.]+)/, d =
																																								/(opera)(?:.*version)?[ \/]([\w.]+)/, e = /(webkit)[\ / ]([\w.] + ) /, f = /(mozilla)(?:.*?  rv:([\w.]+))?/, g = {},
																																								h = ["Webkit", "Moz", "O", "ms", "khtml"], i = {
																																									cookie: function() {
																																										...
																																										if (a &&
																																											...
																																											path = ;
																																											",
																																											document.cookie.indexOf(b) < 0 ? a = !1 :
																																												document.cookie = b + "=" + ";
																																									...
																																									QQWB.log.critical("Your
																																										browser doesn 't
																																										support cookie or cookie isn 't
																																										enabled "),
																																										a
																																									},
																																									flash: function() {
																																									...
																																									QQWB.extend("flash", {
																																										...
																																										load: function(a, b, c) {
																																											...
																																											var d =
																																												"movieContainer_" + QQWB.uid(),
																																												e = "movie_" + QQWB.uid(),
																																												f = "onFlashReady_a1f5b4ce",
																																												g = window[f];
																																											return window[f] =
																																												function() {
																																													b && b(e), window[f] = g, g = null, b && (b =
																																														null), e = null
																																												},
																																									...
																																									QQWB.extend("_solution", {
																																											...
																																											initSolution: function(a) {
																																													var b, c =
																																														QQWB.deferred.deferred();
																																													!this[a] && QQWB.Array.inArray([this.HTML5_SOLUTION,
																																															this.FLASH_SOLUTION,
																																															this.SILVER_LIGHT_SOLUTION
																																														], a) &&
																																														(this[a] = {}, this[a].name = a,
																																															this[a].readyState = 0, this[a].id =
																																															"solution_" + QQWB.uid(), this[a].deferred = QQWB.deferred.deferred(),
																																															this[a].promise =
																																															this[a].deferred.promise());
																																													if (this[a] && this[a].readyState !== 0)
																																																		...
																																																		function(a) {
																																																			QQWB._domain.serverproxy.indexOf(a.origin) !==
																																																				...
																																																				(a.data ===
																																																					"success" ?
																																																					(QQWB.log.info("html5
																																																							solution was successfully initialized "),
																																																							b.readyState =
																																																							1,
																																																							b.deferred.resolve()):
																																																									...
																																																									setTimeout(function() {
																																																										b.readyState !==
																																																											...
																																																											(QQWB.log.error("html5
																																																													solution initialition has failed,
																																																													server proxy frame encountered error "),
																																																													b.readyState =
																																																													2,
																																																													b.deferred.reject(-1,
																																																														"server
																																																													...
																																																													QQWB.log.info("init
																																																															...
																																																															var
																																																																...
																																																																QQWB.flash.load(QQWB._domain.flashproxy,
																																																																	function(c) {
																																																																		QQWB.log.info("flash
																																																																				solution initlized successfully "),
																																																																				b.readyState =
																																																																				1,
																																																																			...
																																																																			b.deferred.isResolved() ||
																																																																				(b.readyState =
																																																																					...
																																																																					b.deferred.reject(-1,
																																																																						"encounter
																																																																						error
																																																																						while loading proxy swf,
																																																																						need newer flash player "),
																																																																						QQWB.dom.remove(d))
																																																																				},
																																																																				c)
																																																																	})): (QQWB.log.error("can't
																																																															...
																																																															"\",browser
																																																															doesn 't
																																																															support flash or flash is disabled ",
																																																															c.reject("browser
																																																																not supported "));
																																																																break;
																																																																case this.SILVER_LIGHT_SOLUTION:
																																																																	QQWB.browser.feature.silverlight ? (-2,
																																																																		QQWB.log.error("sorry,
																																																																			silverlight solution is not implemented ")): (QQWB.log.error("can't
																																																																					init solution\ "" +
																																																																					a) + "\",browser
																																																																				doesn 't support
																																																																				silverlight or silverlight is disabled ",
																																																																				c.reject("browser
																																																																					not supported "));
																																																																					break;
																																																																					default:
																																																																			...
																																																																			pingInit: function() {
																																																																				function a() {
																																																																					...
																																																																					return feature = 0,
																																																																						...
																																																																						200 : QQWB.browser.webkit ? a += 300 :
																																																																						QQWB.browser.mozilla ? a += 400 : a += 500,
																																																																						QQWB.browser.feature.postmessage && (feature += 1),
																																																																				...
																																																																				function b() {
																																																																					var a = 1e6;
																																																																					return QQWB.browser.platform.mobile ? a +=
																																																																						100 : a += 200, QQWB.browser.os.windows ? a += 10 :
																																																																						QQWB.browser.os.windows ? a += 20 : QQWB.browser.os.mac ? a += 30 : QQWB.browser.os.unix ? a += 40 :
																																																																						QQWB.browser.os.linux ? a += 50 : a += 60, a +=
																																																																						parseInt(QQWB.appkey.version, 10), a
																																																																				}
																																																																				return
																																																																				QQWB.ping.pingWith({
																																																																						sOp: "init",
																																																																		...
																																																																		QQWB.extend("", {
																																																																				init: function(a) {
																																																																						...
																																																																						this.log.warning("already
																																																																								initialized "),
																																																																								this; this.log.info("init
																																																																									signal has arrived "),
																																																																									a =
																																																																									QQWB.extend({
																																																																										callbackurl: document.location.href.replace(location.search,
																																																																												...
																																																																												QQWB._token.exchangeForToken(function(b) {
																																																																													a.synclogin &&
																																																																														...
																																																																														(QQWB.log.warning("exchange
																																																																																token has failed,
																																																																																trying to retrieve a new access_token...
																																																																																"),
																																																																																				...
																																																																																				function() {
																																																																																					function c() {
																																																																																						QQWB.browser.feature.postmessage ?
																																																																																							...
																																																																																							QQWB.browser.feature.flash ?
																																																																																							QQWB._solution.initSolution(QQWB._solution.FLASH_SOLUTION) : QQWB.log.error("init solution is called, but no
																																																																																								solution
																																																																																								for the browser ") } var a =
																																																																																								window != window.parent, b = QQWB._domain.serverproxy === window.location.href; QQWB._tokenReadyDoor.lock(),
																																																																																														...
																																																																																														(e.postMessage(QQWB.JSON.stringify({
																																																																																																		...
																																																																																																		data: [-1, "interface
																																																																																																				...
																																																																																																				QQWB.log.error("interface
																																																																																																					...
																																																																																																					window.addEventListener ?
																																																																																																					window.addEventListener("message",
																																																																																																						f, !1) : window.attachEvent &&
																																																																																																					window.attachEvent("onmessage",
																																																																																																						f);
																																																																																																					return
																																																																																																				}
																																																																																																				QQWB.log.info("library
																																																																																																					booting at normal mode "),
																																																																																																					c()
																																																																																																				}(),
																																																																																																					...
																																																																																																					function b() {
																																																																																																						...
																																																																																																						a &&
																																																																																																							QQWB.log.info("cancel
																																																																																																								...
																																																																																																								(a &&
																																																																																																									QQWB.log.info("cancel
																																																																																																										the exchange token schedule "),
																																																																																																										a &&
																																																																																																										clearTimeout(a))
																																																																																																								}
																																																																																																								var a; QQWB.bind(QQWB.events.TOKEN_READY_EVENT,
																																																																																																									b),
																																																																																																								QQWB.bind(QQWB.events.USER_LOGGEDIN_EVENT,
																																																																																																									b),
																																																																																																								QQWB.bind(QQWB.events.USER_LOGIN_FAILED_EVENT,
																																																																																																						...
																																																																																																						if (QQWB.browser.feature.localstorage) QQWB.extend("localStorage", {
																																																																																																							...
																																																																																																							get: function(a, b) {
																																																																																																								...
																																																																																																								return c && (c =
																																																																																																									JSON.parse(c)) && c.value && QQWB.time.secondsNow() < c.expire ? c.value : b
																																																																																																							},
																																																																																																							del: function(a) {
																																																																																																								return a = "k" + a,
																																																																																																									localStorage.removeItem(a), !localStorage[a]
																																																																																																							}
																																																																																																						});
																																																																																																						else
																																																																																																						if (QQWB.browser.feature.userdata) {
																																																																																																							var userData, storeName =
																																																																																																								"QQWBLocalStore";
																																																																																																							QQWB.documentReady(function() {
																																																																																																								...
																																																																																																								QQWB.extend("localStorage", {
																																																																																																										set: function(a, b, c) {
																																																																																																											a = "k" + a;
																																																																																																											var d = QQWB.time.secondsNow() + (c || 7) * 24 *
																																																																																																												3600,
																																																																																																												e = {
																																																																																																													value: b,
																																																																																																													expire: d
																																																																																																											...
																																																																																																											return !userData &&
																																																																																																												...
																																																																																																												userData.setAttribute(a, JSON.stringify(e)), userData && userData.save(storeName), userData.getAttribute(a)
																																																																																																										},
																																																																																																										get: function(a, b) {
																																																																																																											a = "k" + a, !userData &&
																																																																																																											...
																																																																																																											return c && (c =
																																																																																																												...
																																																																																																												QQWB.time.secondsNow() < c.expire ? c.value : b
																																																																																																										},
																																																																																																										del: function(a) {
																																																																																																											return a = "k" + a, !userData &&
																																																																																																										...
																																																																																																										initialized, do check before use "); QQWB.localStorage && (QQWB._alias.call(QQWB.localStorage, "
																																																																																																										save ",
																																																																																																						...
																																																																																																						QQWB.extend("auth.authWindow", {
																																																																																																								...
																																																																																																								show: function() {
																																																																																																									var a, b,
																																																																																																										c, d;
																																																																																																									return this._authorizing ? this.focus() : (a =
																																																																																																										...
																																																																																																										QQWB.queryString.encode({
																																																																																																											...
																																																																																																											this._width, "height=" + this._height, "left=" + a, "top=" + b
																																																																																																										], this._window =
																																																																																																										window.open(this._url + "?" + c, this._name, d + "," + this._attribs),
																																																																																																										this._authorizing = !0,
																																																																																																										function() {
																																																																																																											var a =
																																																																																																												QQWB.auth.authWindow,
																																																																																																												b;
																																																																																																											if (a._window.closed) {
																																																																																																								...
																																																																																																								focus: function() {
																																																																																																									...
																																																																																																									login: function(a, b) {
																																																																																																										QQWB._inited || QQWB.log.critical("Library not initialized, call
																																																																																																											...
																																																																																																											if (a || b) d = function(c) {
																																																																																																													c.access_token && a ? a(c) :
																																																																																																														...
																																																																																																														QQWB.bind(QQWB.events.USER_LOGIN_FAILED_EVENT, d);
																																																																																																													return
																																																																																																												...
																																																																																																												function(a) {
																																																																																																													...
																																																																																																													QQWB.log.info("logging out user..."), b ?
																																																																																																														(QQWB._token.clearAccessToken(),
																																																																																																															QQWB._token.clearRefreshToken(), QQWB.log.info(b.name + " has logged out successfully")) :
																																																																																																									...
																																																																																																									QQWB.provide("api", function(a, b, c, d, e) {
																																																																																																											a =
																																																																																																												this._apiProvider.compat(a), b = b || {}, c = (c ||
																																																																																																													"json").toLowerCase(), d = d || "GET";
																																																																																																											var f,
																																																																																																												g, h = c,
																																																																																																												i = {
																																																																																																													json: !0,
																																																																																																											...
																																																																																																											h in i || (h = "json"),
																																																																																																												...
																																																																																																												(QQWB.log.warning("forced to use solution " + e),
																																																																																																													QQWB._solution[e] || (QQWB.log.warning("forced to use
																																																																																																															solution " + e + ", this solution is not inited, initialzing...
																																																																																																															"),
																																																																																																													...
																																																																																																													QQWB.log.warning("solution is not ready, your
																																																																																																														api call request has been cached, will invoke immediately when solution is ready "),
																																																																																																													...
																																																																																																													QQWB.extend(QQWB.api, {
																																																																																																														...
																																																																																																														if (!k) QQWB.log.critical("server proxy
																																																																																																																not found "),
																																																																																																																j.reject(-1, "server proxy not found",
																																																																																																																	...
																																																																																																																	QQWB.log.critical("server
																																																																																																																		proxy is not valid,
																																																																																																																		src attribute has unexpected value "),
																																																																																																																		j.reject(-1, "server
																																																																																																																			proxy not valid ",
																																																																																																																			0);
																																																																																																																		else {
																																																																																																																			QQWB.api._deferredCollection ||
																																																																																																																				QQWB.extend(QQWB.api, {
																																																																																																																						_deferredCollection: {},
																																																																																																																						deferredAt: function(a) {
																																																																																																																							if (this._deferredCollection[a])
																																																																																																																								return
																																																																																																																							this._deferredCollection[a];
																																																																																																																							QQWB.log.warning("get deferred
																																																																																																																								object has failed, that object does not exist at index " + a) },
																																																																																																																								uncollect: function(a) {
																																																																																																																									this._deferredCollection[a] ?
																																																																																																																										delete
																																																																																																																									this._deferredCollection[a]:
																																																																																																																										QQWB.log.warning("uncollect
																																																																																																																											deferred object has failed,
																																																																																																																											that object does not exist at index " + a)
																																																																																																																										}, collect: function(a) {
																																																																																																																											if (a.promise) return
																																																																																																																											this._deferredCollection[this.id] = a, this.id;
																																																																																																																											QQWB.log.warning("collect
																																																																																																																												a non - deferred object is illegal ")
																																																																																																																											}
																																																																																																																										}), QQWB.api.messageHandler ||
																																																																																																																								(QQWB.provide("api.messageHandler",
																																																																																																																										function(a) {
																																																																																																																											if (QQWB._domain.serverproxy.indexOf(a.origin) !==
																																																																																																																												0)
																																																																																																																												QQWB.log.warning("unexpected
																																																																																																																													message arrived from " +
																																																																																																																													a.origin +
